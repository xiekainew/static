    ...
    <div class="seller" ref="seller">
        <div class="seller-content">
            <div class="overview">
                ...
                <div class="desc border-1 border-1px">
            ...
            <div class="bulletin">
                ...
                <div class="content-wrapper border-1 border-1px">
                    <p class="content">{{seller.bulletin}}</p>
                </div>
                <ul v-if="seller.supports" class="supports">
                    <li class="supports-item border-1 border-1px border-none" v-for="(item , index) in seller.supports">
            ...
            <split></split>
            <div class="info">
                <h1 class="title border-1 border-1px">商家信息</h1>
                <ul>
                    <li class="info-item border-1 border-1px border-none" v-for="info in seller.infos">
                        {{info}}
